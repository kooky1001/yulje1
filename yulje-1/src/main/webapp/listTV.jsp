...
<div class="row">
  ...
  <!-- 페이지의 이름. -->
  	...
  	<div class="part_content"> 
		  ...
		  <div class="grid-item" style="cursor: pointer;" onclick="location.href='pageTV.jsp';">
		  	<div class="tv">
		  		<img src="thum01.jpg">
		  	</div>
		  	<div class="tv_title">美, 코로나 확진자수 하루 7만명 넘어</div>
		  </div> 
		  <div class="grid-item">
		  	<div class="tv">
		  		<img src="thum02.jpg">
		  	</div>
		  	<div class="tv_title">독감백신 사망자 40명 돌파</div>
		  </div> 
		  <div class="grid-item">
		  	<div class="tv">
		  		<img src="thum03.jpg">
		  	</div>
		  	<div class="tv_title">암 세포에 관한 모든 것</div>
		  </div> 
		  <div class="grid-item">
		  	<div class="tv">
		  		<img src="thum03.jpg">
		  	</div>
		  	<div class="tv_title">영상 제목.</div>
		  </div> 
		  <div class="grid-item">
		  	<div class="tv">
		  		<img src="thum01.jpg">

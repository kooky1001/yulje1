  ...
  <div class="column middle">
 	...
 	<!-- 페이지의 이름. -->
  	...
  	<div class="part_content"> 
  		<div id="tv_title">
  			<span>美, 코로나 확진자수 하루 7만명 넘어</span>
  			<span id="view">조회수 : 363</span>
  		</div>
  		<div id="tv_page">
  		
  		<iframe width="800" height="500"
  		src="https://www.youtube.com/embed/dI-EJkTqyFM" 
  		frameborder="0" 
		...
		<div class="bottom">
		<div id="next">
			<p>다음글 : 다음 유튜브 영상 페이지로 갑니다.</p>
			<p>이전글 : 이전 유튜브 영상 페이지로 갑니다.</p>
		</div>
		
		<div id="btn">
			<button style="cursor: pointer;" onclick="location.href='listTV.jsp';">목록</button>
		</div>
		</div>
  	</div>

...
<div class="row">
  ...
  <!-- 페이지의 이름. -->
  	...
  	<!-- 약품설명 -->
  		<div id="medi_table">
		<div class="medi_row">
		<span class="cell col1"><img src="tylenol.jpg"></span>
		<span class="cell col2"><p id="col_title">타이레놀</p></span>
		</div>
		<div class="medi_row">
		<span class="cell col1">설명</span>
		<span class="cell col2">해열진통제</span>
		</div>
		<div class="medi_row">
		<span class="cell col1">주의사항</span>
		<span class="cell col2">복용 시 으깨거나 씹거나 녹이지 말고 그대로 삼켜야 합니다.</span>
		</div>
		</div>
  	</div>
  	...
  	<!-- 리스트번호 -->
	<div class="bottom">
		<button id="btn" style="cursor: pointer;" onclick="location.href='listMedicine.jsp';">목록</button>
	</div>

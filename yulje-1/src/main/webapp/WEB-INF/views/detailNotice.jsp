...
<div class="content">
	...
	조회수 : ${n.hit }<br>
	<hr>
	<textarea rows="10" cols="60" readonly="readonly">${n.content }</textarea><br>
	<c:if test="${n.fname != null }">
		첨부파일 : <a href="./upload/${n.fname }">${n.fname }</a><br>
	</c:if><br>
	<!-- 
	<a href="insertAdvice.do?no=${a.no }"><input type="button" value="답글"></a>

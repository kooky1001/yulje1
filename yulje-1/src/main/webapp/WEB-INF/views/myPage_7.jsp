						...
						<form id="updateForm">
							<div id="mypage_title_sub">
								<div class="mypage_title_sub_div1">
									<span class="mypage_title_sub_span1"><h4>기본정보 입력</h4></span> <span
										class="mypage_title_sub_span2"><font color="orange">*</font>
										필수입력항목입니다</span>
								</div>
										...
										<tbody>
											...
											<div class="table_tr">
												<tr>
													<th>아이디</th>
													<td><div class="table_input">
															<span id="table_span2">sisi</span>
														</div></td>
												</tr>
											</div>
											<div class="table_tr">
												<tr>
													<th>비밀번호 확인<font color="orange">*</font></th>
													<td><div class="table_input">
															<span id="table_span3"><input type="password"
																name="pwd" id="pwd"></span>
														</div></td>
												</tr>
											</div>
											<div class="table_tr">
												<tr>
													...
													<td><div class="table_input">
															<span id="table_span4"> <select class="text-2"
																name="tel1">
																	<option>010</option>
																	<option>011</option>
																	<option>016</option>
															</select></span> - <input type="text" name="tel2" id="tel2"> - <input
																type="text" name="tel3" id="tel3">
														</div></td>
												</tr>
											</div>
											<div class="table_tr">
												<tr>
													...
													<td><div class="table_input">
															<span id="table_span5"><input type="text"
																name="str_email01" id="str_email01" style="width: 100px">

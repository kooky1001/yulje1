...
<body>
	...
	<tr>
	<td class="title" height="400px">진료내용</td>
	<td class="content">${c.cli_content }</td>
	</tr>
	
	<tr>
	<td class="title" height="250px">처방약품</td>
	<td class="content"><a href="detailMedicine.do?medi_no=${c.medi_no }"><button id="btn_medi">${medi_name }</button></a></td>
	</tr>
	</table>
	<!-- 
	진료번호 : ${c.cli_no } &nbsp;|&nbsp;
	...
	<hr>
	<a href="listClinic.do"><button id="btn_li">목록</button></a>
</body>
</html>